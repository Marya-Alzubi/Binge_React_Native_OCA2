...
const Category1 = ({navigation}) => (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.movieItemContainer}>
        {listToMatrix(dataCat1, 2).map((movieRow, i) => (
...
const styles = StyleSheet.create({
  ...
  headerContainer: {  paddingHorizontal: 25 , borderBottomColor: 'white', borderBottomWidth: 1,marginBottom: 20},
  headerText: {fontFamily: 'Oswald_600SemiBold', fontSize: 32, color: '#fff',margin: "auto" , textAlign: 'left' , paddingVertical : 20},
