    ...
    <View style={styles.container}>
      ...
      <View style={styles.bottomContainer}>
        ...
        <View>
          ...
          <Text style={[styles.textWhite, styles.desc]} numberOfLines={6}>{movie.desc}</Text>
        </View>
      </View>
      <Footer trailer={movie.trailer} />
...
const styles = StyleSheet.create({
  ...
  title: {fontFamily: 'Oswald_600SemiBold', fontSize: 48, textTransform: 'uppercase', lineHeight: 56, marginVertical: 20},
});
